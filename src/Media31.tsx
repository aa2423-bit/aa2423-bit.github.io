...
export function Evidence({slugs,images=[],hideCertificates=false,compactLinks=false}:{slugs:string[];images?:Slide[];hideCertificates?:boolean;compactLinks?:boolean}){
